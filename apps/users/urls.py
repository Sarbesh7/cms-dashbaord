...
from .views import LoginView,UserView,ChangePasswordView,ResetPasswordView,UserDetailView,RefreshTokenView,LogoutView
...
urlpatterns = [
    ...
    path("api/v1/users/refresh-token/", RefreshTokenView.as_view()),
]
